...
public class MyRequestsPlayedAdapter extends ArrayAdapter<AvailableTrack> {
    private final static int textViewResourceId = R.layout.my_requests_played_list_item;

    public MyRequestsPlayedAdapter(Context context) {
